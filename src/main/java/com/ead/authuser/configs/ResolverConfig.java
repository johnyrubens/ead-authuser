...
public class ResolverConfig implements WebMvcConfigurer {
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        var pageableArgumentResolver = new PageableHandlerMethodArgumentResolver();
    ...
    public void addCorsMappings(CorsRegistry registry) {
        // Example de restrição
        //registry.addMapping("/users/**").allowedOrigins("http://example.com");
        //registry.addMapping("/auth/**").allowedOrigins("http://example-auth.com");
